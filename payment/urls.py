...
from .views import PaymentTypeView, AllPaymentView, PaymentDetailView, PhysicalView, PhysicalPaymentView, TotalPayment, TotalTuitionForMonth, StudentPaymentHistory
