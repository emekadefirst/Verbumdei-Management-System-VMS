...
from .views import (
    ...
    StaffDetailAPIView,
    AccountInfoListCreateAPIView,
    AccountInfoDetailAPIView,
    PayrollListCreateAPIView,
    PayrollDetailAPIView,
    PayrollExportAPIView,
    AccountCountView,
    StaffCountView,
    StaffSearch,
)
...
urlpatterns = [
    path("search/", StaffSearch.as_view(), name="student-search"),
    ...
    path(
        "account-info/",
        AccountInfoListCreateAPIView.as_view(),
        name="account-info-list-create",
    ),
    path(
        "account-info/<int:pk>/",
        AccountInfoDetailAPIView.as_view(),
        name="account-info-detail",
    ),
    ...
    path(
        "payroll/export/<str:pay_period>/",
        PayrollExportAPIView.as_view(),
        name="payroll-export",
    ),
]
